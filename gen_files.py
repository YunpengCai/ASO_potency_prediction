...
def randomize_with_mask(fname, seqs_to_gen, n_times_randomize_seq, mask=None):
    """
    mask should be a dictionary like {HER2:3255-3379; COX-2: 1488-1521} with unique names and positions
    """
